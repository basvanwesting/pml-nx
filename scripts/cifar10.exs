defmodule Cifar10 do
  ...
  def call do
    ...
    train_batches = Scidata.CIFAR10.download()      |> prepare_scidata_streams(@batch_size)
    test_batches  = Scidata.CIFAR10.download_test() |> prepare_scidata_streams(@batch_size)
    ...
    Axon.Display.as_table(model, Nx.template({1, 3, 32, 32}, :f32)) |> IO.puts
